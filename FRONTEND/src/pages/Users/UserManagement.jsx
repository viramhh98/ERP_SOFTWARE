...
const UserManagement = () => {
  ...
  const loadAllConfig = async () => {
    ...
    try {
      ...
      const [roleRes, userRes, masterRes] =
        await Promise.all([
          api.get("/role"),
          api.get("/user-company-role/all-users"),
          api.get(
            "/user-company-role/allcompanybranches"
          ),
        ]);
      ...
      const currentCompanyData =
        masterRes.data.find(
          (c) => c.companyId === activeCompId
        );

      if (currentCompanyData) {
        setAvailableBranches(
          currentCompanyData.branches || []
        );
      }
    } catch (err) {
      toast.error("Cloud synchronization failed");
  ...
  const updateAssignment = (
    ...
    newAssignments[idx][field] = value;
          ...
          <div className="px-4 md:px-8 h-[92px] flex items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3 shrink-0">
              ...
              <button
                ...
                className="h-12 px-6 rounded-2xl bg-slate-900 text-white font-black flex items-center gap-2 shadow-lg hover:shadow-indigo-200 hover:bg-indigo-600 transition-all active:scale-95"
              >
                <UserPlus size={18} />
                Add User
              </button>
        ...
        <div className="px-4 md:px-8 pt-[150px] pb-10">
          ...
          <div className="max-w-[1600px] mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="rounded-[32px] p-8 bg-slate-900 text-white shadow-xl relative overflow-hidden">
                  ...
                  <tbody className="divide-y divide-slate-50 font-bold">
                    ...
                    {syncing ? (
                      ...
                      <tr>
                        <td
                          colSpan="5"
                          className="py-40 text-center text-slate-300 font-black uppercase tracking-widest"
                        >
                          No Personnel Found
                        </td>
                      </tr>
                      ...
                      filteredUsers.map((u) => (
                        ...
                        >
                          ...
                          <td className="px-8 py-6 text-center">
                            ...
                            <span className="px-4 py-1.5 rounded-full text-[10px] font-black tracking-widest ring-1 ring-inset bg-indigo-50 text-indigo-600 ring-indigo-100 uppercase">
                          ...
                          <td className="px-8 py-6 text-center">
                            ...
                            <span className="px-4 py-1.5 rounded-full text-[10px] font-black tracking-widest ring-1 ring-inset bg-emerald-50 text-emerald-600 ring-emerald-100 uppercase">
                              Active
                            </span>
                          </td>
                          ...
                          <td className="px-8 py-6 text-center">
                            ...
                            <button
                              ...
                              className="h-10 w-10 bg-slate-100 text-slate-400 rounded-xl flex items-center justify-center hover:bg-indigo-600 hover:text-white transition-all shadow-sm mx-auto"
                            >
                              <Eye size={18} />
                            </button>
                          </td>
            ...
            <div className="bg-white w-full max-w-2xl rounded-[40px] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
              ...
              <div className="px-10 py-8 border-b flex justify-between items-center bg-slate-50/50">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="h-14 w-14 bg-indigo-600 rounded-[1.25rem] flex items-center justify-center text-white shadow-xl">
                    <User size={28} />
                  </div>
              ...
              <div className="p-10 space-y-8">
                ...
                <div>
                  ...
                  <h3 className="text-sm font-black uppercase tracking-[0.2em] text-slate-400 mb-4 px-2">
                  ...
                  <div className="space-y-3">
                    ...
                    {selectedUser.assignments?.map(
                      (asm, i) => (
                        <div
                          key={i}
                          className="p-5 bg-white border border-slate-100 rounded-3xl flex items-center justify-between hover:border-indigo-200 transition-all shadow-sm"
                        >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="h-10 px-4 rounded-xl bg-indigo-50 text-indigo-600 font-black text-[10px] uppercase tracking-widest flex items-center gap-2 hover:bg-indigo-100 transition-all"
                    >
                      <Plus size={14} />
                      Add
                    </button>
                  ...
                  <div className="space-y-3">
                    ...
                    {formData.assignments.map(
                      (row, i) => (
                        <div
                          key={i}
                          className="p-4 bg-slate-50 rounded-[24px] border border-slate-100 flex flex-col sm:flex-row gap-4 items-center"
                        >
                          ...
                          <div className="flex-1 grid grid-cols-2 gap-4 w-full">
                            ...
                            <select
                              ...
                              required
                              className="w-full bg-white border border-slate-200 rounded-xl px-4 py-4 text-xs font-black text-slate-600 outline-none focus:ring-4 focus:ring-indigo-50"
                            >
                              <option value="">
                                LOCATION
                              </option>
                          ...
                          {formData.assignments
                            ...
                            <button
                              ...
                              className="h-12 w-12 bg-rose-50 text-rose-500 rounded-2xl flex items-center justify-center hover:bg-rose-100 transition-all"
                            >
                              <Trash2
                                size={18}
                              />
