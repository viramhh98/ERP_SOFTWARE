    ...
    <MainLayout>
      <div className="min-h-screen bg-[#F8FAFC] p-4 lg:p-10 font-inter text-slate-700">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          ...
          {/* Low Stock Alert */}
          <div className="bg-slate-900 p-6 rounded-4xl shadow-xl flex flex-col justify-between text-white">
            <div className="flex justify-between items-start">
          ...
          {/* Quick Actions */}
          <div className="bg-indigo-600 p-6 rounded-4xlshadow-xl flex flex-col justify-between text-white">
