        ...
        <div className="max-w-7xl mx-auto mb-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <div className="relative flex-1 md:w-96 group">
              ...
              <Search
                className="absolute left-4 top-3.5 text-slate-400 group-focus-within:text-emerald-500 transition-colors"
                size={18}
              />
              ...
              <tbody className="divide-y divide-slate-100">
                ...
                {loading ? (
                  ...
                  <tr>
                    <td
                      colSpan="7"
                      className="p-24 text-center font-black text-slate-300 uppercase tracking-widest"
                    >
                      No Sales Found
                    </td>
                  </tr>
                  ...
                  filteredSales.map((s) => (
                    ...
                    <tr
                      key={s._id}
                      className="group hover:bg-emerald-50/30 transition-all cursor-default font-bold"
                    >
                      ...
                      <td className="px-8 py-6 text-center">
                        ...
                        <span
                          className={`px-4 py-1.5 rounded-full text-[10px] font-black tracking-tighter ring-1 ring-inset uppercase ${
                            s.status ===
                            "PAID"
        ...
        {showModal &&
          selectedSale && (
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 lg:p-8 bg-slate-900/40 backdrop-blur-sm">
              ...
              <div className="bg-white w-full max-w-2xl rounded-[3rem] shadow-2xl overflow-hidden border border-white/20 relative">
                ...
                <div className="p-8">
                  ...
                  <div className="flex justify-between items-center bg-slate-900 text-white p-8 rounded-4xl">
                    ...
                    <button className="flex flex-col items-center gap-1 group">
                      ...
                      <div className="p-4 bg-emerald-600 rounded-2xl group-hover:scale-110 transition-all">
