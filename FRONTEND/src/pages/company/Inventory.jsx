...
const Inventory = () => {
  ...
  const filteredStock = stock.filter((s) => {
    ...
    /* IMPORTANT */
    const matchesMaintainStock = showAllItems
      ? true
      : s.itemId?.maintainStock === true;

    return matchesSearch && matchesMaintainStock;
  });
    ...
    <MainLayout>
            ...
            <div className="flex items-center gap-3 shrink-0">
              ...
              <div className="relative group hidden md:block">
               ...
               <button
                ...
                className={`h-12 px-5 rounded-2xl font-black text-sm transition-all border ${
                  showAllItems
                    ? "bg-slate-900 text-white border-slate-900"
                    : "bg-blue-600 text-white  border-slate-200"
                }`}
              >
                {showAllItems ? "Show Stock Items" : "Show All Items"}
              </button>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex justify-end bg-slate-900/60 backdrop-blur-sm">
          <div className="w-full max-w-2xl h-full bg-white shadow-2xl overflow-hidden border-l border-slate-200 animate-in slide-in-from-right duration-300">
            {/* HEADER */}
            <div className="p-8 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] uppercase tracking-[0.3em] font-black text-indigo-500 mb-1">
                    Inventory / Create
                  </p>
              ...
              <button
                onClick={() => setIsModalOpen(false)}
                className="h-12 w-12 rounded-2xl bg-white border border-slate-200 flex items-center justify-center hover:bg-rose-50 hover:text-rose-500 transition-all"
              >
                <X size={20} />
              </button>
            </div>
            ...
            <form
              ...
              className="p-8 space-y-6 overflow-y-auto h-[calc(100%-100px)]"
            >
              {/* ITEM NAME */}
              <div className="space-y-2">
                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">
                ...
                <input
                  ...
                  className="w-full h-14 px-5 bg-slate-50 border border-slate-200 rounded-2xl font-bold text-sm outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 text-slate-800"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="COF-ARB-01"
                    className="w-full h-14 px-5 bg-slate-50 border border-slate-200 rounded-2xl font-bold text-sm uppercase outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 text-slate-800"
                  />
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="Beverages"
                    className="w-full h-14 px-5 bg-slate-50 border border-slate-200 rounded-2xl font-bold text-sm outline-none"
                  />
                </div>
              ...
              {/* TOGGLES */}
              <div className="flex items-center gap-39 pt-2 flex-wrap">
              ...
              <div className="pt-8 flex gap-3">
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                  className="flex-1 h-14 rounded-2xl border border-slate-200 text-slate-500 font-black hover:bg-slate-50 transition-all"
                >
                  Cancel
                </button>
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex-1 h-14 rounded-2xl bg-slate-900 hover:bg-indigo-600 text-white font-black flex items-center justify-center gap-2 shadow-lg transition-all"
                >
                  <Save size={18} />
